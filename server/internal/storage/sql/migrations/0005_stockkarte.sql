...
ALTER TABLE inspection ADD COLUMN drone_frame_cut BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE inspection ADD COLUMN super_added     BOOLEAN NOT NULL DEFAULT FALSE;
