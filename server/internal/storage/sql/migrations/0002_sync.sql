...
ALTER TABLE apiary   ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE hive      ADD COLUMN updated_hlc TEXT NOT NULL DEFAULT '';
ALTER TABLE hive      ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE queen   ADD COLUMN updated_hlc TEXT NOT NULL DEFAULT '';
ALTER TABLE queen   ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE inspection ADD COLUMN updated_hlc TEXT NOT NULL DEFAULT '';
ALTER TABLE inspection ADD COLUMN deleted BOOLEAN NOT NULL DEFAULT FALSE;
